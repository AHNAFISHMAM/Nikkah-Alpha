-- =============================================
-- Insert All Pre-Marriage Modules and Lessons
-- =============================================
-- This migration inserts all 5 modules and 20 lessons
-- from the seed.sql file into the database.
-- Safe to run multiple times (idempotent with ON CONFLICT)
-- =============================================
...
-- Expected: 5 modules with their lesson counts
