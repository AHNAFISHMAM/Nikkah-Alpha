-- =====================================================
-- COMPLETE DATABASE SETUP FOR NIKAHPREP
-- This file creates all tables AND seeds initial data
...
-- Add foreign key constraint separately (with proper type matching)
DO $$ BEGIN
  IF NOT EXISTS (
...
-- Add foreign key constraint for module_id separately
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'user_module_progress_module_id_fkey'
  ) THEN
